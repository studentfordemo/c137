...
export default class DetailsScreen extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      //url: `http://192.168.1.16:5000/planet?name=${this.props.navigation.getParam(
      // url : 'http://8dd6a6731dc0.ngrok.io/planet?name=${this.props.navigation.getParam(
        "planet_name"
        // url :  flask api localhost link
      )}`
    };
  }
